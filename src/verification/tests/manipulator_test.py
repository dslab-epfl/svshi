...
def test_manipulator_manipulate_mains_raises_invalid_function_call_exception_because_of_unchecked_in_invariant_verification_true():
    manipulator = Manipulator(
        {
...
def test_manipulator_manipulate_mains_raises_invalid_function_call_exception_because_of_unchecked_in_invariant_verification_false():
    manipulator = Manipulator(
        {
            (f"{TESTS_DIRECTORY}/fake_wrong_app_library", "fifth_app"): set(
                [
...
def test_manipulator_manipulate_mains_raises_invalid_function_call_exception_because_of_open_in_an_unchecked_verification_false():
    manipulator = Manipulator(
        {
