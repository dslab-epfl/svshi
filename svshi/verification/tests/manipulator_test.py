...
def test_manipulator_manipulate_mains_raises_invalid_function_call_exception_because_of_unchecked_in_precond():
    manipulator = Manipulator(
        {
...
def test_manipulator_manipulate_mains_raises_invalid_function_call_exception_because_of_print_in_precond():
    manipulator = Manipulator(
        {
