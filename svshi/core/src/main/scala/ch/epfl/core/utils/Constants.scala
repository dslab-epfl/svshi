...
object Constants {
  ...
  val GENERATED_TEMP_FOLDER_DURING_REMOVING_PATH = os.Path(GENERATED_TEMP_FOLDER_DURING_REMOVING_PATH_STRING)
  ...
  val GENERATED_VERIFICATION_FILE_PATH: Path = os.Path(s"$SVSHI_FOLDER/verification/$GENERATED_VERIFICATION_FILE_NAME")
  val GENERATED_RUNTIME_FILE_NAME = "runtime_file.py"
  val GENERATED_RUNTIME_FILE_PATH: Path = os.Path(s"$SVSHI_FOLDER/verification/$GENERATED_RUNTIME_FILE_NAME")
  val GENERATED_CONDITIONS_FILE_NAME = "conditions.py"
  val GENERATED_CONDITIONS_FILE_PATH: Path = os.Path(s"$SVSHI_FOLDER/verification/$GENERATED_CONDITIONS_FILE_NAME")
  ...
  val DELETED_APPS_FOLDER_PATH = os.Path(DELETED_APPS_FOLDER_PATH_STRING)
}
